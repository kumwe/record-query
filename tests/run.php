 ...
 *
 * Assertions come from Kumwe\Record\Query\Tests\TestCase. Composer installation
...
spl_autoload_register(static function (string $class): void {
    $prefixes = [
        'Kumwe\\Record\\Query\\Tests\\' => __DIR__ . '/',
        'Kumwe\\Record\\Query\\' => dirname(__DIR__) . '/src/',
    ];
...
foreach ($files as $file) {
    $class = 'Kumwe\\Record\\Query\\Tests\\Case\\' . basename($file, '.php');
    if (!class_exists($class) || !is_subclass_of($class, 'Kumwe\\Record\\Query\\Tests\\TestCase')) {
...
echo "Record Query suite passed: {$totalTests} tests, {$totalAssertions} assertions.\n";
